...
### User who does not need any help with accessing this project/using git/etc.
  ...
  - To knit the formatted output 'Article_2_Self-Scoring_Output_Summary.Rmd' in the main directory, you will need to 
...
<b>To directly inspect the formatted output file of the analysis script:</b>
   ...
   - Open 'Article_2_Self-Scoring_Output_Summary.Rmd' in the main directory and click 'knit'
...
10.Choose [the place you liked, for example Desktop] --> Article_2_Self-Scoring_Output_Summary.Rmd  
...
9. Press File --> Open File  
10.Choose C:&#92;Cool_RProject&#92;Article_2_Self-Scoring_Output_Summary.Rmd  
